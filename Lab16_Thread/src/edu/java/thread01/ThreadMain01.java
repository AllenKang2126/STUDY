...
public class ThreadMain01 {
	...
	public static void main(String[] args) {
		...
		// main thread가 다른 thread들의 실행이 끝날 때까지 기다림
		try {
			th1.join(); // th1가 끝날 때까지 main 쓰레드가 기다림
			th2.join(); // th2가 끝날 때까지 main 쓰레드가 기다림
		} catch (InterruptedException e) {
			e.printStackTrace();
		}

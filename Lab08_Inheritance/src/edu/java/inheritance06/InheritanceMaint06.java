...
public class InheritanceMaint06 {
	
	public static void main(String[] args) {
		// Object 클래스의 메서드 override: toString(), hashCode(), equals(), ...
		
		Point pt1 = new Point();
		// 자바의 모든 클래스는 Object를 상속받기 때문에, Object클래스의 public 메서드들을 사용할 수 있음.
		...
		// ==, != 연사자는 인스턴스가 생성된 주소값(참조값)을 직접 비교.
		...
		// 참조타입(String, Object, ...)의 같음/ 다름 비교는 equals() 메서드를 사용.
...
class Point {
	...
	@Override
	public int hashCode() {
		// equals() 메서드가 true를 리턴하는 인스턴스들은 hashCode()의 리턴 값이 같아야 함!

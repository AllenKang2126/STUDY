...
public class WrapperMain02 {
	...
	public static void main(String[] args) {
		...
		// 기본 타입 범위(최소값 ~ 최대값)를 넘어서는 숫자들은 변수에 할당할 수 없음.
//		long longNumber = 90000000000000000000L;  // long 타입의 범위를 넘어서는 숫자(리터럴)을 만들 수도 없음.
		...
		// 생성자를 호출할 때 보통 문저열을 파라미터에 전달함.
		// 이유는 자바가 만들어 낼 수 있는 범위를 넘어서는 숫자를 만들어 내기 위해서.
		BigInteger big1 = new BigInteger("10125125120125012501250125012502013");
		...
		System.out.println(d1 - d2);  // -> 0.2 예상

...
// 3) public default 메서드 - Java 8 버전부터 생김. body({...})가 구현된 메서드.  << class 에서는 default 수식어 사용하지 않음.
...
// 5) private static 메서드, private 메서드 - Java 9버정부터 생김. body(P{...}가 구현된 메서드
...
interface Test {
	...
	// 4. public static 메서드 - Java 8. public 생략가능
	static void test3() {

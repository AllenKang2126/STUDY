...
// this:
// 1) 객체가 생성된 곳의 주소 - 참조 연산자(.)과 함께 사용 ex) this. id.
// 2) 생성자 - (예) this(), this(값, ...)
...
//		this.id = id;
//		this.name = "unknown";  // 파라미터 2개를 갖는 생성자를 호출.

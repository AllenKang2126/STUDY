...
public class AppMain09 {
	...
	// JComboBox의 아이템으로 사용하기 위한 문자열 배열을 정리
	private static final String[] ITEMS = {"Meta(Facebook)", "Instagram", "Youtbe"};
	...
	private void initialize() {
		...
		rbPrivate.setBounds(5, 5, 135, 35);
		...
		rbPackage.setBounds(145, 5, 135, 35);
		...
		rbProtected.setBounds(285, 5, 135, 35);
		...
		rbPublic.setBounds(425, 5, 135, 35);
		...
		cbAbstract.setBounds(5, 55, 135, 40);
		...
		cbStatic.setBounds(145, 55, 135, 40);
		...
		cbFinal.setBounds(285, 55, 135, 40);
		...
		// ComboBoxModdel : 콤보 박스에서 보여질 아이템들을 가지고 있는 객체
		DefaultComboBoxModel<String> comboModel = new DefaultComboBoxModel<>(ITEMS);
		// 콤보 박스에 ComboBoxModel 객체를 설정 -> 선택할 수 있는 리스트(아이템)가 설정됨.
		comboBox.setModel(comboModel);
		comboBox.setFont(new Font("D2Coding", Font.PLAIN, 20));
		comboBox.setBounds(5, 101, 175, 35);
		...
		btnConfirm.setBounds(5, 159, 135, 40);
		frame.getContentPane().add(btnConfirm);
		
		textArea = new JTextArea();
		textArea.setBounds(5, 207, 567, 244);
	...
	private void showInfo() {
		...
		buffer.append(btnModel.getSelectedObjects()).append("\n");

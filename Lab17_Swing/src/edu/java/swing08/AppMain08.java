...
public class AppMain08 {
	...
	private void initialize() {
		...
		btnMsgDlg.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				JOptionPane.showMessageDialog(
						...
						null);  // 아이콘 (넣어주지 않아도 무방)
			}
		});
		btnMsgDlg.setFont(new Font("D2Coding", Font.PLAIN, 32));
		btnMsgDlg.setBounds(12, 10, 300, 50);
		...
		btnConfirmDlg.setBounds(12, 70, 300, 50);
		...
		btnOptionDlg.setBounds(12, 130, 300, 50);
...
//				String input = JOptionPane.showInputDialog(frame, "나이는?", 0);
				...
				Object input = JOptionPane.showInputDialog(
						...
						values[0]);  // initialSelectionValue
				System.out.println("input = " + input);
			}
		});
		btnInputDlg.setFont(new Font("D2Coding", Font.PLAIN, 32));
		btnInputDlg.setBounds(12, 188, 300, 50);
		...
		btnCustomDlg.setBounds(12, 248, 300, 50);
		...
		btnCustomFrame.setFont(new Font("D2Coding", Font.PLAIN, 32));
		btnCustomFrame.setBounds(12, 308, 300, 50);

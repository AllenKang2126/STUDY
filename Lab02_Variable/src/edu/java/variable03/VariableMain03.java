...
public class VariableMain03 {
	...
	public static void main(String[] args) {
		...
		// 1.234, 12.34, 123.4 마치 소수점이 떠다니는 듯한 번호(floating point number)
		// 논리 타입 : boolean(true or false만을 저장하는 타입)
		
		// byte 타입 변수 a를 선언하고, 값 1을 저장.
		byte a = 1;
		System.out.println("a = " + a);
		
		// 변수 a의 값을 128으로 변경하려고 하면 에러 발생.
		...
		// short 타입에는 -32,768 ~ 32767 범위의 숫자만 저장할 수 있기 때문에.
		// b = 32768;
	}
